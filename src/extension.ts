...
export function activate(context: vscode.ExtensionContext) {
    ...
    const isMethodDefinition = (line: string): boolean => {
    ...
    const getMethodMatch = (line: string): RegExpMatchArray | null => {
    ...
    let expandAllCommand = vscode.commands.registerCommand('nixUpstreamCheck.expandAll', async () => {
        const expandRecursively = async (node: NixUpstreamNode) => {
...
// Placeholder tree provider
    ...
    class NixUpstreamTreeProvider implements vscode.TreeDataProvider<NixUpstreamNode> {
        ...
        nodeFromTree(tree: any, checked: boolean): NixUpstreamNode {
